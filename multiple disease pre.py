...
diabetes_model = pickle.load(open('"D:\Project\multiple disease prediction\diabetes_model.sav"', 'rb'))

heart_disease_model = pickle.load(open('"D:\Project\multiple disease prediction\heart_disease_model.sav"','rb'))
